...
$config = array(
    // 网站标题
     'title' => '送你图床',
    // 网站关键字
     'keywords' => '送你图床,送礼,无数据库图床,PHP多图长传程序,自适应页面,HTML5,markdown,bbscode,一键复制',
    // 网站描述
     'description' => '送你图床是一款支持多文件上传的无数据库图床,可以完美替代PHP多图上传程序，最新html5自适应页面兼容手机电脑，上传后返回图片直链，markdown图片，论坛贴图bbscode链接，简单方便支持一键复制，支持多域名，api上传。',
    // 网站公告
     'tips' => ' 单个文件限制5M，每次最多上传30张图片,请捣乱的出门左拐！！',
    // 图片直链域名 末尾不加"/" 如果你想上传域名是a.com但是我想上传之后返回域名是b.com  那就在这里填写b.com
     'domain' => 'http://imgs.songli.art/',
    ...
    // 登录上传密码和管理密码 管理的管理员账号：admin 密码为下面密码
     'password' => 'samyxue8341',
    // 是否开启API上传
     'apiStatus' => false,
    // 是否开启水印:0关闭，1文字水印，2图片水印 动态gif不能添加水印
     'watermark' => 0,
    // 水印文字内容
     'waterText' => '送你图床 imgs.songli.art',
    /**
     * 水印位置
